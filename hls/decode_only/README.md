...
1. 将 decode kernel 接口与未来的 shared library wrapper 对齐。
2. 通过 `verification/` 中的整网校验，把 prefill 后的 cache 继续用于 decode step 对比。
3. 后续再引入更细的量化、banking 和 Catapult directives。