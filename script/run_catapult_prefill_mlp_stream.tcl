...
set solution_name qwen_prefill_mlp_stream_solution
set top_function llm_accel::qwen_prefill_mlp_stream_top_catapult
...
set design_files [list \
	[file join $hls_root prefill_only qwen_prefill_mlp_stream_top.cpp] \
